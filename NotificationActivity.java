...
public class NotificationActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions options=
                ...
                .build();
        FirebaseRecyclerAdapter<Contacts, FindPeopleActivity.NotificationViewHolder> firebaseRecyclerAdapter
                = new FirebaseRecyclerAdapter<Contacts, FindPeopleActivity.NotificationViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull FindPeopleActivity.NotificationViewHolder holder, int i, @NonNull Contacts contacts)
            {
            ...
            @NonNull
            @Override
            public FindPeopleActivity.NotificationViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.find_friend_design,parent,false);
                FindPeopleActivity.NotificationViewHolder viewHolder = new FindPeopleActivity.NotificationViewHolder(view);
                return viewHolder;
             }
        };
